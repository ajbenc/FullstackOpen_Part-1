...
import { LightningCSSOptions } from 'vitevite/types/internal/lightningcssOptions.jsport { LightningCSSOptions } from 'vite/vite/types/internal/lightningcssOptions.jsort { SassLegacyPreprocessBaseOptions, SassModernPreprocessBaseOptions, LessPreprocessorBaseOptions, StylusPreprocessorBaseOptions } from 'vite/tvite/types/internal/cssPreprocessorOptions.jsrt { M as ModuleRunnerTransport } from './moduleRunnerTransport.d-CXw_Ws6P.js';
export { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from 'vite/tyvite/types/importGlob.jst { ChunkMetadata } from 'vite/typvite/types/metadata.jsface Alias {
  find: string | RegExp
  replacement: string
  /**
